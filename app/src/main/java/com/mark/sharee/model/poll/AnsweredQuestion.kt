...
abstract class AnsweredQuestion(@SerialName(value = "type") open val type: String) {
        ...
        private fun convertQuestionToAnsweredQuestion(question: Question): AnsweredQuestion {
            return when (question.type) {
                Question.QuestionType.BOOLEAN ->
                    BooleanAnswer(question.answer as Boolean, question.id)
                Question.QuestionType.NUMERICAL ->
                    NumericalAnswer(question.answer as Int, question.id)
...
data class BooleanAnswer(
    @SerialName(value = "answer") var answer: Boolean?, override var questionId: Long)
