...
abstract class Operation internal constructor(private val navigator: Navigator) {
    private val subject: PublishSubject<ShareeFragment> = navigator.subject
    ...
    protected fun onNext(fragment: ShareeFragment) {
        subject.onNext(fragment)
    }

    fun withAnimations(@AnimRes enterAnimation: Int, @AnimRes exitAnimation: Int,
                       @AnimRes popEnterAnimation: Int, @AnimRes popExitAnimation: Int): Operation {
